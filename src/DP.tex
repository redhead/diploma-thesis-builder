...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% informace o~práci
\newcommand\WorkTitle{Event-Sourcing Desing Pattern in a Java Enterprise Application}		% název
...
\newcommand\StudProgram{Open Informatics, Master's degree}	% program
